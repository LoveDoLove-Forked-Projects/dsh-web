...
export const ru: Record<string, string> = {
  ...
  'usage.bank.hint': 'Каждый токен, израсходованный в официальном DeepSeek, чеканит один кит-юань; сохраните или поделитесь купоном.',
  'usage.bank.minted': 'Намончено {tokens} токенов (около ¥{cost})',
