...
| 目录 | npm 包 | 版本 | 发布状态 |
| --- | --- | --- | --- |
| packages/dsh-git-graph | @linxin666/dsh-client-ui-git-graph | 0.4.2 | public |
| packages/dsh-i18n | @linxin666/dsh-i18n | 0.4.2 | public |
| packages/dsh-liangshen | @linxin666/dsh-liangshen | 0.4.2 | public |
| packages/dsh-market | @linxin666/dsh-client-ui-market | 0.4.2 | public |
| packages/dsh-model-capabilities | @linxin666/dsh-client-ui-model-capabilities | 0.4.2 | public |
| packages/dsh-plugin-manager | @linxin666/dsh-client-ui-plugin-manager | 0.4.2 | public |
| packages/dsh-remote-web-ui | @linxin666/dsh-remote-web-ui | 0.4.2 | public |
| packages/dsh-session-archive | @linxin666/dsh-session-archive | 0.4.2 | public |
| packages/dsh-session-id | @linxin666/dsh-client-ui-session-id | 0.4.2 | public |
| packages/dsh-skill-explorer | @linxin666/dsh-client-ui-skill-explorer | 0.4.2 | public |
| packages/dsh-ssh | @linxin666/dsh-ssh | 0.4.2 | public |
| packages/dsh-task-board | @linxin666/dsh-client-ui-task-board | 0.4.2 | public |
| packages/dsh-usage | @linxin666/dsh-usage | 0.4.2 | public |
| packages/dsh-web-all | @linxin666/dsh-web-all | 0.4.2 | public |
| packages/dsh-web-settings | @linxin666/dsh-client-ui-web-ui-settings | 0.4.2 | public |
...
pnpm libs:check
pnpm build
node scripts/verify-version.mjs 0.4.2
```
